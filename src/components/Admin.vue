...
async function addRole(){
   ...
   try {
      ...
      error.value = err.response?.data?.message || 'Fetching Roles failed'
      throw err
   } 
}
...
async function fetchEquipment(){
    ...
    try {
        await api.get('getEquipment', { headers: { 'Authorization': `Bearer ${token}` } })
        .then(function (response) {
            if(response.data){
...
async function addEquipment(){
   ...
   try {
      ...
      error.value = err.response?.data?.message || 'Fetching Equipment failed'
      throw err
   } 
}
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            ...
                            <v-row>
                                ...
                                <v-col md="6">
                                    <v-date-input label="Date of Birth" v-model="dateOfBirth" required :rules="[rules.required]"></v-date-input>
                                </v-col>
                            </v-row>
                            <v-row>
                        ...
                        <v-card-text>
                            <v-row>
                             ...
                             <v-row>
                                ...
                                <v-col md="6">
                                    <v-text-field label="Value" v-model="value" required :rules="[rules.required]"></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col md="6">
